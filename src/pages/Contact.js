        ...
        <Box sx={{ width: {md:1100, xs: "96%"}, margin: "auto", marginTop: {md:10, xs: 2},}}>
            <Box sx={{paddingY: {md:20, xs: 13}, display: {md:"flex", xs: "block"}, gap: 12}}>
                ...
                <Box sx={{width: {md:560, xs: "100%"}, marginTop: {md: 0, xs: 3}, textAlign: {md:"start", xs: "center"} }}>
                    ...
                    <Typography sx={{fontSize: 17, marginTop: 3}}>Dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia.</Typography>
                   ...
                   <Link href="/">
                     <Button style={{textTransform: "capitalize", color: "white", fontWeight: "bold", fontSize: 20, marginTop: 30, backgroundColor: "#FA4729", padding: 15, paddingLeft: 40, paddingRight: 40, borderRadius: 0}}>Go Back</Button>
                   </Link>
                </Box>
            </Box>
        </Box>
